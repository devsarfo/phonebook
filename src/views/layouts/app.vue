    ...
    <div class="flex flex-col min-h-screen overflow-hidden">
                ...
                <div class="relative flex items-center justify-between h-16">
                    <div class="flex-0 flex items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div class="flex-shrink-0 flex items-center">
                            <div @click="data.sideMenu = !data.sideMenu" id="sidebar-toggle" class=" ml-2 mr-4">
                                <i class="fa fa-bars fa-lg text-white cursor-pointer"></i>
                            </div>
        ...
        <main class="flex-grow pt-16">
            <div class="flex">
                ...
                <div class="container mx-auto py-8 md:w-4/5 w-11/12 md:px-6">
